...
import 'package:grocerieslist_app/models/category.dart';
            ...
            children: [
              TextFormField(
                ...
                decoration: const InputDecoration(
                    label: Text('Name'), hintText: 'Flour'),
                validator: (value) {
                  if (value == null ||
                      value.isEmpty ||
                      value.trim().length <= 1 ||
                      value.trim().length >= 50) {
                    return 'Must have length of 2 to 50 characters';
                  } else {
                    return null;
                  }
                },
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        if (value == null ||
                          ...
                          return 'Must be a valid positive numver';
                        } else {
                          return null;
                        }
                      },
